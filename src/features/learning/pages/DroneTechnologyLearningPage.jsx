      ...
      <div className="mx-auto max-w-7xl p-6">
        <div className="grid grid-cols-12 gap-6">
          ...
          <main className="col-span-12 space-y-6 lg:col-span-9">
            ...
            {chapter.id === 1 ? <DroneChapterOneLesson /> : chapter.id === 2 ? <DroneChapterTwoLesson /> : chapter.id === 3 ? <DroneChapterThreeLesson /> : chapter.id === 4 ? <DroneChapterFourLesson /> : chapter.id === 5 ? <DroneChapterFiveLesson /> : <ChapterPlaceholder chapter={chapter} />}
