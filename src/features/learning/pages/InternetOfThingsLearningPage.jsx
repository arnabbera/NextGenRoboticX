      ...
      <div className="mx-auto max-w-7xl p-6">
        <div className="grid grid-cols-12 gap-6">
          ...
          <main className="col-span-12 space-y-6 lg:col-span-9">
            ...
            {chapter.id === 1 ? <InternetOfThingsChapterOneLesson /> : chapter.id === 2 ? <InternetOfThingsChapterTwoLesson /> : chapter.id === 3 ? <InternetOfThingsChapterThreeLesson /> : <ChapterPlaceholder chapter={chapter} />}
