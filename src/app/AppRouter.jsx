      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<Layout />}>
            ...
            <Route path="/courses/raspberry-pi/mock-test" element={<RoboticsTestPage />} />
            <Route path="/courses/raspberry-pi/assessment" element={<RoboticsTestPage />} />
            <Route path="/courses/drone-technology/mock-test" element={<RoboticsTestPage />} />
            <Route path="/courses/drone-technology/assessment" element={<RoboticsTestPage />} />
